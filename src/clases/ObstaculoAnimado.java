...
public class ObstaculoAnimado extends ElementosGenerales{
	...
	public ObstaculoAnimado(int x, int y, int anchoImagen, int altoImagen, String indiceImagen, int velocidad, String animacionActualC, int yImagen, int xImagen) {
	...
	public ObstaculoAnimado(int x, int y, int xImagen, int yImagen, int altoImagen, int anchoImagen, int velocidad,
